...
This project is indexed by GitNexus as **ControlHub-Backend** (5360 symbols, 12466 relationships, 160 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
