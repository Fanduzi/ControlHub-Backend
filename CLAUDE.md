...
This project is indexed by GitNexus as **ControlHub** (2550 symbols, 5367 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
