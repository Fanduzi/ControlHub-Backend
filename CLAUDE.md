...
This project is indexed by GitNexus as **ControlHub** (2699 symbols, 5743 relationships, 76 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
