...
| machine_principal.go | Independent machine-principal metadata, closed scopes, credential lifecycle records, and 30/90-day expiry rules |
...
- `MachinePrincipal`, `MachineCredential`, the five closed `MachineScope` values, and bounded expiry normalization
