...
| resource_handler.go | Resource list/detail handlers; create/PATCH expose origin, aliases, and external identifiers, return explicit identity conflict codes, and route changes through atomic inventory audit |
