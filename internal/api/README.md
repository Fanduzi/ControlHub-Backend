...
| named_inventory_view_handler_test.go | Named inventory view list/create router tests, including shared-management metadata, strict JSON, and controlled errors |
