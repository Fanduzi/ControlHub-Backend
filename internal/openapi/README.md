...
| File | Responsibility |
|------|---------------|
| openapi.yaml | Source OpenAPI contract, including Operator Access Boundary security, schema-policy, admin-only auth-audit and query-evidence metrics responses, and the closed ErrorResponse.error Controlled Error Code enum |
