...
| File | Responsibility |
|------|---------------|
| openapi.yaml | Source OpenAPI contract, including Operator Access Boundary security, schema-policy, and admin-only auth-audit and query-evidence metrics responses |
