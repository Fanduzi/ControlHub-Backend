...
| File | Responsibility |
|------|---------------|
| openapi.yaml | Source OpenAPI contract, including Operator Access Boundary security, inventory audit field diffs, Domain Name/Virtual IP profile keys, metrics responses, and the closed Controlled Error Code enum |
