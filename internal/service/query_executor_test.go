...
// output: TestNewScanPointer_*, TestNormalizeScanned_* (NULL correctness + numeric type fidelity)
// pos: Unit tests verifying SQL NULL is preserved as nil and non-null numbers stay numbers
