...
| ingestion_confirm_test.go | Discoverable real-MySQL User and collector confirmation tests: issue #83 behavior plus discovered/ownerless collector create, machine audit attribution, server fingerprint validation, complete/incomplete/failed Missing lifecycle, recovery, exact/conflicting retry, never-archive, and whole-transaction rollback |
