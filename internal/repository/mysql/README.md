...
| user_repository.go | User credential lookup by email/id; Authorization Version mutators (role/active/password) |
...
| auth_audit_emitter.go | MySQL-backed AuthAuditEmitter — fail-open INSERT for auth/authz audit events |
